...
class ConfiguracionEmpresaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'prefijo_facturas', 'prefijo_boletas', 'prefijo_guias',
            'siguiente_factura', 'siguiente_boleta', 'siguiente_guia',
            'imprimir_logo', 'pie_pagina_documentos',
            'alerta_stock_minimo', 'notificar_vencimientos',
            'respaldo_automatico', 'frecuencia_respaldo'
        ]
        widgets = {
            'prefijo_facturas': forms.TextInput(attrs={
                'class': 'form-control',
                'maxlength': 10
            }),
            'prefijo_boletas': forms.TextInput(attrs={
                'class': 'form-control',
                'maxlength': 10
            }),
            'prefijo_guias': forms.TextInput(attrs={
                'class': 'form-control',
                'maxlength': 10
            }),
            'siguiente_factura': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 1
            }),
            'siguiente_boleta': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 1
            }),
            'siguiente_guia': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 1
            }),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            TabHolder(
                Tab('Documentos',
                    Row(
                        Column('prefijo_facturas', css_class='col-md-4'),
                        Column('prefijo_boletas', css_class='col-md-4'),
                        Column('prefijo_guias', css_class='col-md-4'),
                    ),
                    Row(
                        Column('siguiente_factura', css_class='col-md-4'),
                        Column('siguiente_boleta', css_class='col-md-4'),
                        Column('siguiente_guia', css_class='col-md-4'),
                    ),
                    Row(

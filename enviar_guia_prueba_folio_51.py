...
# -*- coding: utf-8 -*-
"""
Script para enviar una guía de despacho de prueba con folio 51 al ambiente de pruebas de DTEBox
"""
import os
import sys
import django
...
def crear_xml_guia_prueba_folio_51():
    """
    Crea un XML de guía de despacho de prueba con folio 51
    ...
    # Datos del documento
    folio = 51
    tipo_dte = 52  # Guía de Despacho Electrónica
    ...
    # Construir XML de la guía de despacho (sin EnvioDTE, solo el Documento)
...
<DscItem>GUIA DE DESPACHO DE PRUEBA CON FOLIO {folio} - AMBIENTE DE PRUEBAS</DscItem>
<QtyItem>1</QtyItem>
...
def enviar_guia_prueba_folio_51():
    print_header("ENVIAR GUIA DE DESPACHO DE PRUEBA - FOLIO 51")
    ...
    try:
        ...
        # Crear XML de la guía de prueba
        print(f"\n2. CREANDO XML DE LA GUIA DE PRUEBA...")
        xml_documento = crear_xml_guia_prueba_folio_51()
        print(f"   Folio: 51")
        print(f"   Tipo DTE: 52 (Guía de Despacho Electrónica)")
        print(f"   Tamaño XML: {len(xml_documento)} caracteres")
        
        # Guardar XML original en archivo
        xml_original_path = "xml_guia_original_folio_51.xml"
        ...
        if certificado_path and os.path.exists(certificado_path):
            try:
                ...
                xml_firmado_path = "xml_guia_firmada_folio_51.xml"
